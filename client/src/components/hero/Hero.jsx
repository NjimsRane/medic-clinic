...
const Hero = () => {
    return (
        < div className="hero mt-24">
            <div className="container flex flex-col gap-6 md:flex-row lg:h-[60vh]  md:items-center">
                <div className="flex flex-col items-center gap-6 flex-1 lg:gap-10 md:items-start" >
                    <h1 className="text-5xl text-center capitalize text-[#20acac] font-semibold leading-tight md:text-start">
                    ...
                    <Link to='/'>
                        <button type="button" className="bg-[#20acac] px-4 py-3 text-2xl capitalize text-white rounded">make appointment</button>
                    </Link>
                </div>
                <div className="flex-1">
                    <img src={child} alt="child" className="rounded h-[50vh] md:h-auto lg:h-[55vh] object-cover w-full block" />
                </div>
            </div>
