        ...
        < div className="hero mt-24">
            <div className="flex flex-col gap-6 md:flex-row lg:h-[80vh]  md:items-center">
                <div className="flex flex-col items-center gap-6 flex-1 lg:gap-10 md:items-start" >
                    <h1 className="text-5xl text-center capitalize text-primary font-semibold leading-tight md:text-start mt-8">
                    ...
                    <Link to='/appointment'>
                        <button type="button" className="bg-primary px-4 py-3 text-2xl capitalize text-white rounded">make appointment</button>
                    </Link>
                </div>
